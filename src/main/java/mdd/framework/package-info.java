 ...
 * There are more classes that you stricly need, but it gives you an idea
 ...
 *   package mostly consists of interfaces that must be insranciated through
 *   a concrete class.
 *   
 ...
 *   work with a BaB+DD solver, but are not stricly necessary if you were
 ...
 *   instanciate the abstractions described in the other two packages.
 */
