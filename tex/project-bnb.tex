...
\Question We use the one-tree relaxation. Show the one-tree that you obtain at the root node of the BnB search tree.
Give the successors of this node. For each, explain the constraints on the branches and depict the internal state representation.
\answerbox{11cm}{
% YOUR ANSWER HERE
}
...
\Question Give the time-complexity and justify your answer (don't forget to specify the spanning tree algorithm that you use)
\answerbox{5cm}{
% YOUR ANSWER HERE
}
